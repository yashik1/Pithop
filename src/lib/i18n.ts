...
const en = {
  ...
  tryLabel: 'Try:',
  hintBody:
    "Enter where you're driving from and to. SideQuest maps your route and finds viewpoints, quirky attractions, nature, history and food along the way.",
  language: 'Language',
};
...
const dicts: Partial<Record<Lang, Partial<Record<TKey, string>>>> = {
  es: {
    ...
    hintBody: 'Indica desde y hasta dónde conduces. SideQuest traza tu ruta y encuentra miradores, atracciones curiosas, naturaleza, historia y comida por el camino.', language: 'Idioma',
  },
  fr: {
    ...
    hintBody: 'Indiquez votre départ et votre arrivée. SideQuest trace votre itinéraire et trouve points de vue, attractions insolites, nature, histoire et restauration en chemin.', language: 'Langue',
  },
  de: {
    ...
    hintBody: 'Gib ein, von wo nach wo du fährst. SideQuest zeichnet deine Route und findet Aussichtspunkte, kuriose Attraktionen, Natur, Geschichte und Essen am Weg.', language: 'Sprache',
  },
  pt: {
    ...
    hintBody: 'Indique de onde e para onde vai. O SideQuest traça a rota e encontra miradouros, atrações curiosas, natureza, história e comida pelo caminho.', language: 'Idioma',
  },
  it: {
    ...
    hintBody: 'Inserisci da dove a dove guidi. SideQuest traccia il percorso e trova punti panoramici, attrazioni curiose, natura, storia e cibo lungo la strada.', language: 'Lingua',
  },
  nl: {
    ...
    hintBody: 'Vul in van en naar waar je rijdt. SideQuest tekent je route en vindt uitzichtpunten, eigenzinnige attracties, natuur, geschiedenis en eten onderweg.', language: 'Taal',
  },
  ru: {
    ...
    hintBody: 'Укажите, откуда и куда едете. SideQuest построит маршрут и найдёт смотровые площадки, необычные достопримечательности, природу, историю и еду по пути.', language: 'Язык',
  },
  uk: {
    ...
    hintBody: 'Вкажіть, звідки й куди їдете. SideQuest побудує маршрут і знайде оглядові точки, незвичні атракції, природу, історію та їжу дорогою.', language: 'Мова',
  },
  pl: {
    ...
    hintBody: 'Podaj skąd i dokąd jedziesz. SideQuest wyznaczy trasę i znajdzie punkty widokowe, ciekawe atrakcje, przyrodę, historię i jedzenie po drodze.', language: 'Język',
  },
  tr: {
    ...
    hintBody: 'Nereden nereye gittiğini gir. SideQuest rotanı çizer ve yol boyunca manzara noktaları, ilginç yerler, doğa, tarih ve yemek bulur.', language: 'Dil',
  },
  ar: {
    ...
    hintBody: 'أدخل من أين وإلى أين تقود. يرسم SideQuest مسارك ويجد نقاط مشاهدة ومعالم طريفة وطبيعة وتاريخًا وطعامًا على الطريق.', language: 'اللغة',
  },
  hi: {
    ...
    hintBody: 'बताएँ कहाँ से कहाँ जा रहे हैं। SideQuest आपका मार्ग बनाता है और रास्ते में व्यू पॉइंट, अनोखे आकर्षण, प्रकृति, इतिहास और खाना खोजता है।', language: 'भाषा',
  },
  id: {
    ...
    hintBody: 'Masukkan dari dan ke mana Anda berkendara. SideQuest memetakan rute dan menemukan titik pandang, atraksi unik, alam, sejarah, dan makanan di jalan.', language: 'Bahasa',
  },
  vi: {
    ...
    hintBody: 'Nhập điểm đi và điểm đến. SideQuest vẽ lộ trình và tìm điểm ngắm cảnh, điểm tham quan độc đáo, thiên nhiên, lịch sử và ẩm thực trên đường.', language: 'Ngôn ngữ',
  },
  zh: {
    ...
    hintBody: '输入你的出发地和目的地。SideQuest 会规划路线，并找出沿途的观景点、有趣景点、自然、历史与美食。', language: '语言',
  },
  ja: {
    ...
    hintBody: '出発地と目的地を入力してください。SideQuest がルートを描き、途中の展望スポット、ユニークな名所、自然、歴史、グルメを見つけます。', language: '言語',
  },
  ko: {
    ...
    hintBody: '출발지와 도착지를 입력하세요. SideQuest가 경로를 그리고 전망 포인트, 독특한 명소, 자연, 역사, 음식을 찾아줍니다.', language: '언어',
  },
};
